...
from curadoria_ofertas.backend.db.database import DATABASE_URL, Base, SessionLocal
from curadoria_ofertas.backend.models.models import Usuario, Oferta, LojaConfiavel, Tag, CanalTelegram, Produto, MetricaOferta
from curadoria_ofertas.backend.utils.auth import hash_password, check_password
from curadoria_ofertas.backend.routes.api import api_bp
