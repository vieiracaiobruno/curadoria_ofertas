...
# Módulos
try:
    from backend.modules.collector_simple import SimpleCollector
except Exception:
    from modules.collector_simple import SimpleCollector  # fallback
...
class RunPipeline:
    ...
    def run(self):
        try:
            ...
            logging.info("Iniciando coleta (SimpleCollector - requests/BS4)…")
            collector = SimpleCollector(self.db)
